...
TOOL_CATEGORIES: dict[str, frozenset[str]] = {
    ...
    "world_model": frozenset({
        ...
        "twm_evaluate_rules_async", "twm_explain_rule_hit", "twm_review_hit",
        "twm_generate_audit_report", "twm_forecast", "twm_forecast_async",
        "twm_counterfactual_rollout", "twm_counterfactual_rollout_async",
        "twm_validation_report", "twm_validation_report_async",
        "twm_world_model_profile", "twm_world_model_profile_async",
        "twm_dynamics_training_examples", "twm_dynamics_training_examples_async",
        "twm_list_rule_hits",
