...
_TOOL_DESCRIPTIONS: dict[str, str] = {
    ...
    "stac_search": "按空间范围、时间、云量和 collection 检索 STAC 卫星影像条目",
    "stac_list_collections": "列出 STAC 端点或卫星预设源的数据集目录",
    # database
...
_TOOL_SCENARIOS: dict[str, list[str]] = {
    ...
    "stac_search": ["卫星影像检索", "STAC 数据发现", "遥感数据获取"],
    "stac_list_collections": ["STAC 数据发现", "卫星数据源浏览", "遥感数据获取"],
...
_TASK_KEYWORDS: dict[str, list[str]] = {
    ...
    "遥感": ["stac_search", "calculate_spectral_index", "describe_raster", "recommend_indices", "assess_cloud_cover"],
    "remote_sensing": ["stac_search", "calculate_spectral_index", "describe_raster", "recommend_indices"],
    "satellite": ["stac_search", "stac_list_collections", "list_satellite_presets"],
    "sentinel": ["stac_search", "stac_list_collections", "list_satellite_presets"],
    "stac": ["stac_search", "stac_list_collections"],
    "imagery": ["stac_search", "stac_list_collections", "assess_cloud_cover"],
    "影像": ["stac_search", "stac_list_collections", "assess_cloud_cover"],
