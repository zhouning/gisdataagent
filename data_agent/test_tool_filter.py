...
class TestIntentToolPredicate(unittest.TestCase):
    ...
    def test_governed_mcp_bridge_survives_general_categories(self):
        """GENERAL routing categories cannot hide the governed MCP entrypoint."""
        current_tool_categories.set({
            "collaboration", "spatial_processing", "database_management"
        })
        self.assertTrue(self.pred(_mock_tool("describe_mcp_asset_workflow")))
        self.assertTrue(self.pred(_mock_tool("run_mcp_asset_workflow")))
...
class TestToolCategories(unittest.TestCase):
    ...
    def test_eight_categories_defined(self):
        ...
        self.assertEqual(len(TOOL_CATEGORIES), 10)
    ...
    def test_expected_categories_exist(self):
        ...
        expected = {
            ...
            "collaboration", "advanced_analysis", "causal_reasoning",
            "world_model",
        }
    ...
    def test_core_has_essential_tools(self):
        ...
        self.assertIn("describe_mcp_asset_workflow", CORE_TOOLS)
        self.assertIn("run_mcp_asset_workflow", CORE_TOOLS)
