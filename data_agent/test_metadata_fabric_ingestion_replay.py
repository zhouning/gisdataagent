...
EXPECTED_APPLY_PLAN_SHA256 = (
    "241cb2018c093f76378d265ab8fb617d161c1be7bd4effa6fad361e9db7522c4"
)
EXPECTED_AUTHORIZATION_SHA256 = (
    "7bc8f577cbdea8d9979b2606278a52176cc2d723a6159c4e1f35ada0f5bb6db0"
)
...
def _provider_payloads():
    metadata = json.loads(
        replay.ingestion.DEFAULT_METADATA_FIXTURE.read_text(encoding="utf-8")
    )
...
def test_policy_scope_effect_expiry_and_approval_binding_fail_closed():
    profile, plan, run, _target, authorization = _inputs()
    decision = replay.parse_policy_decision_artifact(
