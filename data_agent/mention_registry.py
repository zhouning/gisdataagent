...
_PIPELINE_TARGETS = [
    {
        "handle": "Liveability",
        "label": "Liveability 智能问数",
        "type": "pipeline",
        "description": "查询 liveability_data_20260730 的宜居设施、人口、评分与供给数据",
        "allowed_roles": ["admin", "analyst"],
        "required_state_keys": [],
        "pipeline": "LIVEABILITY_NL2SQL",
        "aliases": ["宜居问数", "宜居性问数", "Liveability问数"],
        "pinned": True,
    },
    {
        "handle": "Makani",
        "label": "Makani 智能问数",
        "type": "pipeline",
        "description": "查询 makani_sync_full 的建筑、行政区、学校与公共设施数据",
        "allowed_roles": ["admin", "analyst"],
        "required_state_keys": [],
        "pipeline": "MAKANI_NL2SQL",
        "aliases": ["Makani问数", "马卡尼问数", "建筑设施问数"],
        "pinned": True,
    },
    {
        "handle": "AbuDhabi",
        "label": "阿布扎比跨库智能问数",
        "type": "pipeline",
        "description": "分别查询 Liveability 与 Makani，并按审核口径组合展示跨库结果",
        "allowed_roles": ["admin", "analyst"],
        "required_state_keys": [],
        "pipeline": "ABU_DHABI_FEDERATED_NL2SQL",
        "aliases": ["阿布扎比问数", "阿布扎比跨库问数", "跨库问数"],
        "pinned": True,
    },
