...
type: "MMFE Field"
title: "规划分区代码"
description: "GHFQDM field in synthetic_urban_boundary."
...
| Value domain | `urban_planning_partition_code` |
...
```json
{
  "domain": "urban_planning_partition_code"
}
```
...
[
  ...
  {
    "detail": "urban_boundary.GHFQDM requirement=required",
    "requirement": "required",
  ...
  {
    "detail": "GHFQDM uses value domain urban_planning_partition_code",
    "domain": "urban_planning_partition_code",
    "domain_item_count": 4,
    "domain_known": true,
    "type": "value_domain"
