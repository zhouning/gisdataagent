...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000072` |
...
| Metric | `overlap_area_m2` = 73625.64 |
| Overlap area m2 | 73625.64 |
| Left overlap ratio | 0.727995 |
| Right overlap ratio | 0.003955 |
| Confidence | 0.99 |
