...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000107` |
...
| Metric | `overlap_area_m2` = 1265.237 |
| Overlap area m2 | 1265.237 |
| Left overlap ratio | 0.374481 |
| Right overlap ratio | 0.000302 |
| Confidence | 0.99 |
