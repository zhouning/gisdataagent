...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000016` |
...
| Metric | `overlap_area_m2` = 1660.737 |
| Overlap area m2 | 1660.737 |
| Left overlap ratio | 0.124829 |
| Right overlap ratio | 8.9e-05 |
| Confidence | 0.99 |
