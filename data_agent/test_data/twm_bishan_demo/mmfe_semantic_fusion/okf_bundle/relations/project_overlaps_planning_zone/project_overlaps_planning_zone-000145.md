...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000145` |
...
| Metric | `overlap_area_m2` = 10003.013 |
| Overlap area m2 | 10003.013 |
| Left overlap ratio | 0.680024 |
| Right overlap ratio | 0.000317 |
| Confidence | 0.99 |
