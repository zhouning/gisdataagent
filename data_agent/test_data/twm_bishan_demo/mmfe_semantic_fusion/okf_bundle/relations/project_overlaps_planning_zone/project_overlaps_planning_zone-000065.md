...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000065` |
...
| Metric | `overlap_area_m2` = 583.728 |
| Overlap area m2 | 583.728 |
| Left overlap ratio | 0.191779 |
| Right overlap ratio | 1.9e-05 |
| Confidence | 0.99 |
