...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000063` |
...
| Metric | `overlap_area_m2` = 1200.654 |
| Overlap area m2 | 1200.654 |
| Left overlap ratio | 0.090021 |
| Right overlap ratio | 0.000239 |
| Confidence | 0.99 |
