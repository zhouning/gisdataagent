...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000067` |
...
| Metric | `overlap_area_m2` = 887.962 |
| Overlap area m2 | 887.962 |
| Left overlap ratio | 0.194474 |
