...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000078` |
...
| Metric | `overlap_area_m2` = 657.755 |
| Overlap area m2 | 657.755 |
| Left overlap ratio | 0.096295 |
| Right overlap ratio | 0.000131 |
| Confidence | 0.99 |
