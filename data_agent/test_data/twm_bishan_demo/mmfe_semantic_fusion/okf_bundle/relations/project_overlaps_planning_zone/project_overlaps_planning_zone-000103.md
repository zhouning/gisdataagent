...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000103` |
...
| Metric | `overlap_area_m2` = 57057.205 |
| Overlap area m2 | 57057.205 |
| Left overlap ratio | 0.516477 |
| Right overlap ratio | 0.003065 |
| Confidence | 0.99 |
