...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000128` |
...
| Metric | `overlap_area_m2` = 1105.302 |
| Overlap area m2 | 1105.302 |
| Left overlap ratio | 0.073766 |
| Right overlap ratio | 5.9e-05 |
| Confidence | 0.99 |
