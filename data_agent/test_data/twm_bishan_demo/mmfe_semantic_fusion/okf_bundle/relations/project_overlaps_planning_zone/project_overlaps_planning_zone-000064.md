...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000064` |
...
| Metric | `overlap_area_m2` = 2442.627 |
| Overlap area m2 | 2442.627 |
| Left overlap ratio | 0.802506 |
| Right overlap ratio | 0.000583 |
| Confidence | 0.99 |
