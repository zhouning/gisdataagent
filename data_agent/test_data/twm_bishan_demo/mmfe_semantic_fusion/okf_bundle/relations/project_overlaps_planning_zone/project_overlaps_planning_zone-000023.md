...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000023` |
...
| Metric | `overlap_area_m2` = 4021.453 |
| Overlap area m2 | 4021.453 |
| Left overlap ratio | 0.021713 |
| Right overlap ratio | 0.003698 |
| Confidence | 0.99 |
