...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000046` |
...
| Metric | `overlap_area_m2` = 4999.882 |
| Overlap area m2 | 4999.882 |
| Left overlap ratio | 0.638379 |
| Right overlap ratio | 0.000269 |
| Confidence | 0.99 |
