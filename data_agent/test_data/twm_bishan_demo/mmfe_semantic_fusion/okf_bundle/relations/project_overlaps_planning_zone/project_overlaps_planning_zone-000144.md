...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000144` |
...
| Metric | `overlap_area_m2` = 105.504 |
| Overlap area m2 | 105.504 |
| Left overlap ratio | 0.007172 |
| Right overlap ratio | 2.5e-05 |
| Confidence | 0.99 |
