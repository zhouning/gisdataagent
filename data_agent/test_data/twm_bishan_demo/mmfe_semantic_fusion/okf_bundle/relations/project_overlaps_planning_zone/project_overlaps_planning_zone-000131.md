...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000131` |
...
| Metric | `overlap_area_m2` = 1680.909 |
| Overlap area m2 | 1680.909 |
| Left overlap ratio | 0.384265 |
| Right overlap ratio | 5.3e-05 |
| Confidence | 0.99 |
