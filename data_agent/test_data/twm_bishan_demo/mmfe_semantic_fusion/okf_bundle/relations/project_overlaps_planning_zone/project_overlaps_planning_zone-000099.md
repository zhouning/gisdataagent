...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000099` |
...
| Metric | `overlap_area_m2` = 973.719 |
| Overlap area m2 | 973.719 |
| Left overlap ratio | 0.222598 |
| Right overlap ratio | 3.1e-05 |
| Confidence | 0.99 |
