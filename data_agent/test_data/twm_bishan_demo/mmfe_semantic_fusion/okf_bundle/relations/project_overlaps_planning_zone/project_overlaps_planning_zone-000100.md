...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000100` |
...
| Metric | `overlap_area_m2` = 3122.196 |
| Overlap area m2 | 3122.196 |
| Left overlap ratio | 0.713751 |
| Right overlap ratio | 0.000168 |
| Confidence | 0.99 |
