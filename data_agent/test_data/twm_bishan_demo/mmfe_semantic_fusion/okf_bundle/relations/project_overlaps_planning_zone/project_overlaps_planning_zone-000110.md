...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000110` |
...
| Metric | `overlap_area_m2` = 33708.182 |
| Overlap area m2 | 33708.182 |
| Left overlap ratio | 0.182 |
| Right overlap ratio | 0.008047 |
| Confidence | 0.99 |
