...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000077` |
...
| Metric | `overlap_area_m2` = 2730.665 |
| Overlap area m2 | 2730.665 |
| Left overlap ratio | 0.39977 |
| Right overlap ratio | 8.7e-05 |
| Confidence | 0.99 |
