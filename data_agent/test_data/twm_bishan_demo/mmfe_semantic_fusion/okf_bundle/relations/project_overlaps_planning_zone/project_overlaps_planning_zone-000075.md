...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000075` |
...
| Metric | `overlap_area_m2` = 2300.889 |
| Overlap area m2 | 2300.889 |
| Left overlap ratio | 0.868129 |
| Right overlap ratio | 7.3e-05 |
| Confidence | 0.99 |
