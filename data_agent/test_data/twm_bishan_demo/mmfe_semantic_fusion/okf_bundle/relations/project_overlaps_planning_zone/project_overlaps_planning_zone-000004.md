...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000004` |
...
| Metric | `overlap_area_m2` = 76358.368 |
| Overlap area m2 | 76358.368 |
| Left overlap ratio | 0.456621 |
| Right overlap ratio | 0.002422 |
| Confidence | 0.99 |
