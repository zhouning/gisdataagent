...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000058` |
...
| Metric | `overlap_area_m2` = 7391.772 |
| Overlap area m2 | 7391.772 |
| Left overlap ratio | 0.2075 |
| Right overlap ratio | 0.006797 |
| Confidence | 0.99 |
