...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000117` |
...
| Metric | `overlap_area_m2` = 1730.426 |
| Overlap area m2 | 1730.426 |
| Left overlap ratio | 0.395585 |
| Right overlap ratio | 5.5e-05 |
| Confidence | 0.99 |
