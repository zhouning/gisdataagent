...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000001` |
...
| Metric | `overlap_area_m2` = 90352.435 |
| Overlap area m2 | 90352.435 |
| Left overlap ratio | 0.991327 |
| Right overlap ratio | 0.002866 |
| Confidence | 0.99 |
