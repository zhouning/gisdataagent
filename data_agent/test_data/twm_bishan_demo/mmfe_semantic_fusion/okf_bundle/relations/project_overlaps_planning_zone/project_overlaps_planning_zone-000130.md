...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000130` |
...
| Metric | `overlap_area_m2` = 118.132 |
| Overlap area m2 | 118.132 |
| Left overlap ratio | 0.027006 |
| Right overlap ratio | 2.8e-05 |
| Confidence | 0.99 |
