...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000124` |
...
| Metric | `overlap_area_m2` = 2013.697 |
| Overlap area m2 | 2013.697 |
| Left overlap ratio | 0.617904 |
| Right overlap ratio | 0.000481 |
| Confidence | 0.99 |
