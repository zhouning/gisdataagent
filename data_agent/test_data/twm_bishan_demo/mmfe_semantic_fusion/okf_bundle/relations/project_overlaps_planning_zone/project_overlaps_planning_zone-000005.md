...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000005` |
...
| Metric | `overlap_area_m2` = 3120.238 |
| Overlap area m2 | 3120.238 |
| Left overlap ratio | 0.018659 |
