...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000079` |
...
| Metric | `overlap_area_m2` = 2393.2 |
| Overlap area m2 | 2393.2 |
| Left overlap ratio | 0.060181 |
| Right overlap ratio | 0.000571 |
| Confidence | 0.99 |
