...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000051` |
...
| Metric | `overlap_area_m2` = 4577.445 |
| Overlap area m2 | 4577.445 |
| Left overlap ratio | 0.476016 |
| Right overlap ratio | 0.000911 |
| Confidence | 0.99 |
