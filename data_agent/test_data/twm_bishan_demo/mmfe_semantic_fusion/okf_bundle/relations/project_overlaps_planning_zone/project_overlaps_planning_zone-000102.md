...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000102` |
...
| Metric | `overlap_area_m2` = 20116.548 |
| Overlap area m2 | 20116.548 |
| Left overlap ratio | 0.182093 |
| Right overlap ratio | 0.000638 |
| Confidence | 0.99 |
