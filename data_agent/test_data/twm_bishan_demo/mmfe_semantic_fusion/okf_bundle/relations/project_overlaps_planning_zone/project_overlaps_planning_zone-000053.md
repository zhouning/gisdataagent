...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000053` |
...
| Metric | `overlap_area_m2` = 250.46 |
| Overlap area m2 | 250.46 |
| Left overlap ratio | 0.002476 |
| Right overlap ratio | 6e-05 |
| Confidence | 0.99 |
