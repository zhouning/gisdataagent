...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000140` |
...
| Metric | `overlap_area_m2` = 13699.319 |
| Overlap area m2 | 13699.319 |
| Left overlap ratio | 0.073966 |
| Right overlap ratio | 0.012596 |
| Confidence | 0.99 |
