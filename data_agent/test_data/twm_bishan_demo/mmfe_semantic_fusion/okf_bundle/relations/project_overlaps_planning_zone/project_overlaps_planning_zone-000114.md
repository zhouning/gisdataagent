...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000114` |
...
| Metric | `overlap_area_m2` = 241.792 |
| Overlap area m2 | 241.792 |
| Left overlap ratio | 0.105931 |
| Right overlap ratio | 5.8e-05 |
| Confidence | 0.99 |
