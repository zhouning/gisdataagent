...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000089` |
...
| Metric | `overlap_area_m2` = 3325.891 |
| Overlap area m2 | 3325.891 |
| Left overlap ratio | 0.826888 |
| Right overlap ratio | 0.000105 |
| Confidence | 0.99 |
