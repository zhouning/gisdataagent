...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000137` |
...
| Metric | `overlap_area_m2` = 629.966 |
| Overlap area m2 | 629.966 |
| Left overlap ratio | 0.006912 |
| Right overlap ratio | 0.00015 |
| Confidence | 0.99 |
