...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000034` |
...
| Metric | `overlap_area_m2` = 2037.045 |
| Overlap area m2 | 2037.045 |
| Left overlap ratio | 0.074912 |
| Right overlap ratio | 6.5e-05 |
| Confidence | 0.99 |
