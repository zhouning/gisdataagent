...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000090` |
...
| Metric | `overlap_area_m2` = 2435.671 |
| Overlap area m2 | 2435.671 |
| Left overlap ratio | 0.436144 |
| Right overlap ratio | 7.7e-05 |
| Confidence | 0.99 |
