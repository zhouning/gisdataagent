...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000018` |
...
| Metric | `overlap_area_m2` = 19688.911 |
| Overlap area m2 | 19688.911 |
| Left overlap ratio | 0.980627 |
| Right overlap ratio | 0.000624 |
| Confidence | 0.99 |
