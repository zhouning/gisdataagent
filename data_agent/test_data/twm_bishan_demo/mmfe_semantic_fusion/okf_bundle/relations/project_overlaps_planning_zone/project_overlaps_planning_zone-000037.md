...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000037` |
...
| Metric | `overlap_area_m2` = 9071.985 |
| Overlap area m2 | 9071.985 |
| Left overlap ratio | 0.992956 |
| Right overlap ratio | 0.000288 |
| Confidence | 0.99 |
