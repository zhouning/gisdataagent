...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000094` |
...
| Metric | `overlap_area_m2` = 5020.867 |
| Overlap area m2 | 5020.867 |
| Left overlap ratio | 0.482872 |
| Right overlap ratio | 0.00027 |
| Confidence | 0.99 |
