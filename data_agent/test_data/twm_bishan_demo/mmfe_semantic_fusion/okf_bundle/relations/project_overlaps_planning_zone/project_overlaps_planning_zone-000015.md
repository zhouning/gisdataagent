...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000015` |
...
| Metric | `overlap_area_m2` = 4771.163 |
| Overlap area m2 | 4771.163 |
| Left overlap ratio | 0.358625 |
| Right overlap ratio | 0.000151 |
| Confidence | 0.99 |
