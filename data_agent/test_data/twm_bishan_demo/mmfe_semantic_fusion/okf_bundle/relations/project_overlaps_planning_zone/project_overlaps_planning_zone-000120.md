...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000120` |
...
| Metric | `overlap_area_m2` = 4012.18 |
| Overlap area m2 | 4012.18 |
| Left overlap ratio | 0.035278 |
| Right overlap ratio | 0.000127 |
| Confidence | 0.99 |
