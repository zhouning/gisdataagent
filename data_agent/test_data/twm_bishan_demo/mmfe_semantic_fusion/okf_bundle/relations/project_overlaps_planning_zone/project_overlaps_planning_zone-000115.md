...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000115` |
...
| Metric | `overlap_area_m2` = 2018.383 |
| Overlap area m2 | 2018.383 |
| Left overlap ratio | 0.884272 |
| Right overlap ratio | 6.4e-05 |
| Confidence | 0.99 |
