...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000011` |
...
| Metric | `overlap_area_m2` = 15067.17 |
| Overlap area m2 | 15067.17 |
| Left overlap ratio | 0.173587 |
| Right overlap ratio | 0.000478 |
| Confidence | 0.99 |
