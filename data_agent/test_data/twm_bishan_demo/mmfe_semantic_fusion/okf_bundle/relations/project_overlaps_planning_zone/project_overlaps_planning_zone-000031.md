...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000031` |
...
| Metric | `overlap_area_m2` = 3884.04 |
| Overlap area m2 | 3884.04 |
| Left overlap ratio | 0.277553 |
| Right overlap ratio | 0.000209 |
| Confidence | 0.99 |
