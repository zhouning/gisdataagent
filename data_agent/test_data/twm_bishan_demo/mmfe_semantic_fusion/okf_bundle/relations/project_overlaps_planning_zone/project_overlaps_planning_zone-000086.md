...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000086` |
...
| Metric | `overlap_area_m2` = 3836.487 |
| Overlap area m2 | 3836.487 |
| Left overlap ratio | 0.89284 |
| Right overlap ratio | 0.000916 |
| Confidence | 0.99 |
