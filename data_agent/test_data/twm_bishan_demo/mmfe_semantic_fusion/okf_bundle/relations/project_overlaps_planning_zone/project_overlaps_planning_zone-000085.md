...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000085` |
...
| Metric | `overlap_area_m2` = 2674.429 |
| Overlap area m2 | 2674.429 |
| Left overlap ratio | 0.101388 |
| Right overlap ratio | 0.000532 |
| Confidence | 0.99 |
