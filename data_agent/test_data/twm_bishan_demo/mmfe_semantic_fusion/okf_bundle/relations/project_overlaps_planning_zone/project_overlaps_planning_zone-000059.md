...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000059` |
...
| Metric | `overlap_area_m2` = 3651.752 |
| Overlap area m2 | 3651.752 |
| Left overlap ratio | 0.102511 |
| Right overlap ratio | 0.000872 |
| Confidence | 0.99 |
