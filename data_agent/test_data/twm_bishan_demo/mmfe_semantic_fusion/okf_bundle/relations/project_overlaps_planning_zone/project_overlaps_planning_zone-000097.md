...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000097` |
...
| Metric | `overlap_area_m2` = 387.475 |
| Overlap area m2 | 387.475 |
| Left overlap ratio | 0.284457 |
| Right overlap ratio | 2.1e-05 |
| Confidence | 0.99 |
