...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000142` |
...
| Metric | `overlap_area_m2` = 145085.076 |
| Overlap area m2 | 145085.076 |
| Left overlap ratio | 0.783354 |
| Right overlap ratio | 0.004602 |
| Confidence | 0.99 |
