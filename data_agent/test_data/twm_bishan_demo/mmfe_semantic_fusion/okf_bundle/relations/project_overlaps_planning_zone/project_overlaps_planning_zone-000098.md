...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000098` |
...
| Metric | `overlap_area_m2` = 246.504 |
| Overlap area m2 | 246.504 |
| Left overlap ratio | 0.056352 |
| Right overlap ratio | 0.000227 |
| Confidence | 0.99 |
