...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000054` |
...
| Metric | `overlap_area_m2` = 29177.478 |
| Overlap area m2 | 29177.478 |
| Left overlap ratio | 0.288501 |
| Right overlap ratio | 0.000925 |
| Confidence | 0.99 |
