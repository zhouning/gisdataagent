...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000025` |
| Relation type | `project_overlaps_planning_zone` |
| Predicate | 落入用途管制分区 |
| Source object | `project` / `PRJ-DEMO-0010` |
| Target object | `planning_zone` / `PLAN-DEMO-001` |
| Target standard role | `planning_zone` |
| TWM usage | `planning_consistency_assessment` |
| Metric | `overlap_area_m2` = 171120.597 |
| Overlap area m2 | 171120.597 |
| Left overlap ratio | 0.923927 |
| Right overlap ratio | 0.009193 |
| Confidence | 0.99 |
