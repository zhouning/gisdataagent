...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000069` |
...
| Metric | `overlap_area_m2` = 515.923 |
| Overlap area m2 | 515.923 |
| Left overlap ratio | 0.117943 |
| Right overlap ratio | 0.000474 |
| Confidence | 0.99 |
