...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000073` |
...
| Metric | `overlap_area_m2` = 27559.283 |
| Overlap area m2 | 27559.283 |
| Left overlap ratio | 0.2725 |
| Right overlap ratio | 0.005486 |
| Confidence | 0.99 |
