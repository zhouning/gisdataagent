...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000126` |
...
| Metric | `overlap_area_m2` = 532.357 |
| Overlap area m2 | 532.357 |
| Left overlap ratio | 0.035529 |
