...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000030` |
...
| Metric | `overlap_area_m2` = 10112.256 |
| Overlap area m2 | 10112.256 |
| Left overlap ratio | 0.722619 |
| Right overlap ratio | 0.000321 |
| Confidence | 0.99 |
