...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000088` |
...
| Metric | `overlap_area_m2` = 675.208 |
| Overlap area m2 | 675.208 |
| Left overlap ratio | 0.167871 |
| Right overlap ratio | 0.000161 |
| Confidence | 0.99 |
