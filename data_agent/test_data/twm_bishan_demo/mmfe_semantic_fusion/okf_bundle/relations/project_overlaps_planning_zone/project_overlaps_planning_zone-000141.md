...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000141` |
...
| Metric | `overlap_area_m2` = 21640.709 |
| Overlap area m2 | 21640.709 |
| Left overlap ratio | 0.116844 |
| Right overlap ratio | 0.005166 |
| Confidence | 0.99 |
