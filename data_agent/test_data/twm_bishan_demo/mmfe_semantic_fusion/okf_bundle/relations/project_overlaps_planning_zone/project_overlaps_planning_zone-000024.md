...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000024` |
...
| Metric | `overlap_area_m2` = 9957.581 |
| Overlap area m2 | 9957.581 |
| Left overlap ratio | 0.053764 |
