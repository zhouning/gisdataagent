...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000055` |
...
| Metric | `overlap_area_m2` = 71702.561 |
| Overlap area m2 | 71702.561 |
| Left overlap ratio | 0.70898 |
| Right overlap ratio | 0.003852 |
| Confidence | 0.99 |
