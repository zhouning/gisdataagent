...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000083` |
...
| Metric | `overlap_area_m2` = 1985.93 |
| Overlap area m2 | 1985.93 |
| Left overlap ratio | 0.075287 |
| Right overlap ratio | 6.3e-05 |
| Confidence | 0.99 |
