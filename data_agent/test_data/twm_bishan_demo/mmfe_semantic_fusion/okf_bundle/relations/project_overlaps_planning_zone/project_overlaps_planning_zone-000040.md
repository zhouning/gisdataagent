...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000040` |
...
| Metric | `overlap_area_m2` = 12344.858 |
| Overlap area m2 | 12344.858 |
| Left overlap ratio | 0.863656 |
| Right overlap ratio | 0.000392 |
| Confidence | 0.99 |
