...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000061` |
...
| Metric | `overlap_area_m2` = 487.677 |
| Overlap area m2 | 487.677 |
| Left overlap ratio | 0.01369 |
| Right overlap ratio | 2.6e-05 |
| Confidence | 0.99 |
