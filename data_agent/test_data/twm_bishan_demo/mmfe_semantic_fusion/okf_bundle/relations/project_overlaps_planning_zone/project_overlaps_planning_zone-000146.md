...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000146` |
...
| Metric | `overlap_area_m2` = 4633.756 |
| Overlap area m2 | 4633.756 |
| Left overlap ratio | 0.315012 |
| Right overlap ratio | 0.000249 |
| Confidence | 0.99 |
