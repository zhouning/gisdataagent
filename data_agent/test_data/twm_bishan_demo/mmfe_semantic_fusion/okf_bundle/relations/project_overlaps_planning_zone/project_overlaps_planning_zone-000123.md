...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000123` |
...
| Metric | `overlap_area_m2` = 27554.162 |
| Overlap area m2 | 27554.162 |
| Left overlap ratio | 0.27245 |
| Right overlap ratio | 0.005485 |
| Confidence | 0.99 |
