...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000060` |
...
| Metric | `overlap_area_m2` = 24331.991 |
| Overlap area m2 | 24331.991 |
| Left overlap ratio | 0.683041 |
| Right overlap ratio | 0.000772 |
| Confidence | 0.99 |
