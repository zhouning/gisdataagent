...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000101` |
...
| Metric | `overlap_area_m2` = 443.54 |
| Overlap area m2 | 443.54 |
| Left overlap ratio | 0.004015 |
| Right overlap ratio | 0.000106 |
| Confidence | 0.99 |
