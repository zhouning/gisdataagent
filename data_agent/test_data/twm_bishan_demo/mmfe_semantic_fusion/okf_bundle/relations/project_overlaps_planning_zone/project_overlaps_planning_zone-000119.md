...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000119` |
...
| Metric | `overlap_area_m2` = 3309.428 |
| Overlap area m2 | 3309.428 |
| Left overlap ratio | 0.029099 |
| Right overlap ratio | 0.00079 |
| Confidence | 0.99 |
