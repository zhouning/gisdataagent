...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000014` |
...
| Metric | `overlap_area_m2` = 738.889 |
| Overlap area m2 | 738.889 |
| Left overlap ratio | 0.055539 |
| Right overlap ratio | 0.000176 |
| Confidence | 0.99 |
