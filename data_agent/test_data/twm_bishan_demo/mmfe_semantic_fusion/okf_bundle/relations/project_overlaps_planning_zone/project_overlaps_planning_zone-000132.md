...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000132` |
...
| Metric | `overlap_area_m2` = 2575.306 |
| Overlap area m2 | 2575.306 |
| Left overlap ratio | 0.588729 |
| Right overlap ratio | 0.000513 |
| Confidence | 0.99 |
