...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000092` |
...
| Metric | `overlap_area_m2` = 822.66 |
| Overlap area m2 | 822.66 |
| Left overlap ratio | 0.079118 |
| Right overlap ratio | 0.000196 |
| Confidence | 0.99 |
