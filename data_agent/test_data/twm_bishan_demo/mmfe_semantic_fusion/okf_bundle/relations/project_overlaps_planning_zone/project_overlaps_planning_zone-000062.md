...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000062` |
...
| Metric | `overlap_area_m2` = 12136.824 |
| Overlap area m2 | 12136.824 |
| Left overlap ratio | 0.909979 |
| Right overlap ratio | 0.01116 |
| Confidence | 0.99 |
