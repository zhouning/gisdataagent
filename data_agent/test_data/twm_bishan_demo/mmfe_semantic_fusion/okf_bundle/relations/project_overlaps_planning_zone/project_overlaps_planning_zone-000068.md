...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000068` |
...
| Metric | `overlap_area_m2` = 2725.527 |
| Overlap area m2 | 2725.527 |
| Left overlap ratio | 0.596922 |
| Right overlap ratio | 0.000543 |
| Confidence | 0.99 |
