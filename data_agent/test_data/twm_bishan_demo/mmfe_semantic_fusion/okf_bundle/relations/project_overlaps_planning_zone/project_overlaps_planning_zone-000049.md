...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000049` |
...
| Metric | `overlap_area_m2` = 4424.121 |
| Overlap area m2 | 4424.121 |
| Left overlap ratio | 0.460071 |
| Right overlap ratio | 0.001056 |
| Confidence | 0.99 |
