...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000087` |
...
| Metric | `overlap_area_m2` = 460.461 |
| Overlap area m2 | 460.461 |
| Left overlap ratio | 0.10716 |
| Right overlap ratio | 1.5e-05 |
| Confidence | 0.99 |
