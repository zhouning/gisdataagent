...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000084` |
...
| Metric | `overlap_area_m2` = 21685.703 |
| Overlap area m2 | 21685.703 |
| Left overlap ratio | 0.822106 |
