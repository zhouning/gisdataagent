...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000109` |
| Relation type | `project_overlaps_planning_zone` |
| Predicate | 落入用途管制分区 |
| Source object | `project` / `PRJ-DEMO-0046` |
| Target object | `planning_zone` / `PLAN-DEMO-004` |
| Target standard role | `planning_zone` |
| TWM usage | `planning_consistency_assessment` |
| Metric | `overlap_area_m2` = 17388.513 |
| Overlap area m2 | 17388.513 |
| Left overlap ratio | 0.093885 |
| Right overlap ratio | 0.015988 |
| Confidence | 0.99 |
