...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000108` |
...
| Metric | `overlap_area_m2` = 2113.893 |
| Overlap area m2 | 2113.893 |
| Left overlap ratio | 0.625663 |
| Right overlap ratio | 6.7e-05 |
| Confidence | 0.99 |
