...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000007` |
...
| Metric | `overlap_area_m2` = 1037.097 |
| Overlap area m2 | 1037.097 |
| Left overlap ratio | 0.006358 |
| Right overlap ratio | 0.000248 |
| Confidence | 0.99 |
