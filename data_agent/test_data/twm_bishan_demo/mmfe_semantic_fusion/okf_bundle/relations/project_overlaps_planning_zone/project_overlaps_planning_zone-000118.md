...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000118` |
...
| Metric | `overlap_area_m2` = 2395.804 |
| Overlap area m2 | 2395.804 |
| Left overlap ratio | 0.547694 |
| Right overlap ratio | 0.000477 |
| Confidence | 0.99 |
