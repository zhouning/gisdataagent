...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000043` |
...
| Metric | `overlap_area_m2` = 3790.244 |
| Overlap area m2 | 3790.244 |
| Left overlap ratio | 0.257668 |
| Right overlap ratio | 0.000204 |
| Confidence | 0.99 |
