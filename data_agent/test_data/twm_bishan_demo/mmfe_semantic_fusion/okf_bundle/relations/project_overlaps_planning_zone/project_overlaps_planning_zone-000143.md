...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000143` |
...
| Metric | `overlap_area_m2` = 4816.408 |
| Overlap area m2 | 4816.408 |
| Left overlap ratio | 0.026005 |
| Right overlap ratio | 0.000259 |
| Confidence | 0.99 |
