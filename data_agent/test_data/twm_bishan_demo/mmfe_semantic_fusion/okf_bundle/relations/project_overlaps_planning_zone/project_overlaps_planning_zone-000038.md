...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000038` |
...
| Metric | `overlap_area_m2` = 64.353 |
| Overlap area m2 | 64.353 |
| Left overlap ratio | 0.007044 |
| Right overlap ratio | 3e-06 |
| Confidence | 0.99 |
