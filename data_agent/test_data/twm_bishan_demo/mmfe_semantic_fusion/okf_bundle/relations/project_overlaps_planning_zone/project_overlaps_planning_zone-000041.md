...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000041` |
...
| Metric | `overlap_area_m2` = 932.88 |
| Overlap area m2 | 932.88 |
| Left overlap ratio | 0.063419 |
| Right overlap ratio | 0.000223 |
| Confidence | 0.99 |
