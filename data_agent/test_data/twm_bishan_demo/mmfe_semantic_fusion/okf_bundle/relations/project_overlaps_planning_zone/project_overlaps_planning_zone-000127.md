...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000127` |
...
| Metric | `overlap_area_m2` = 10511.654 |
| Overlap area m2 | 10511.654 |
| Left overlap ratio | 0.701534 |
| Right overlap ratio | 0.000333 |
| Confidence | 0.99 |
