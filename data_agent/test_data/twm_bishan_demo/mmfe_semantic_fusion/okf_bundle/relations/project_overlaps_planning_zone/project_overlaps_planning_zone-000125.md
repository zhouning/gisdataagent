...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000125` |
...
| Metric | `overlap_area_m2` = 1245.217 |
| Overlap area m2 | 1245.217 |
| Left overlap ratio | 0.382096 |
| Right overlap ratio | 3.9e-05 |
| Confidence | 0.99 |
