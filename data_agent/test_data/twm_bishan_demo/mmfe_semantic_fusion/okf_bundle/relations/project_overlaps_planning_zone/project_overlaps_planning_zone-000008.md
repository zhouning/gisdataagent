...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000008` |
...
| Metric | `overlap_area_m2` = 13469.078 |
| Overlap area m2 | 13469.078 |
| Left overlap ratio | 0.082573 |
| Right overlap ratio | 0.000427 |
| Confidence | 0.99 |
