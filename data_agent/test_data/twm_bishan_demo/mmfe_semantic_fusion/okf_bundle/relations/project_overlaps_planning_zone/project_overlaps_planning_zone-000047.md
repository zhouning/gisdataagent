...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000047` |
...
| Metric | `overlap_area_m2` = 313.984 |
| Overlap area m2 | 313.984 |
| Left overlap ratio | 0.040089 |
