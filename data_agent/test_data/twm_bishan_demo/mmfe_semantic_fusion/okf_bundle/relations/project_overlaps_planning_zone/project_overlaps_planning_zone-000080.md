...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000080` |
...
| Metric | `overlap_area_m2` = 21446.459 |
| Overlap area m2 | 21446.459 |
| Left overlap ratio | 0.539304 |
| Right overlap ratio | 0.00068 |
| Confidence | 0.99 |
