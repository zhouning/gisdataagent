...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000116` |
...
| Metric | `overlap_area_m2` = 248.117 |
| Overlap area m2 | 248.117 |
| Left overlap ratio | 0.056721 |
