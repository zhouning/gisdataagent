...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000129` |
...
| Metric | `overlap_area_m2` = 2846.217 |
| Overlap area m2 | 2846.217 |
| Left overlap ratio | 0.189953 |
| Right overlap ratio | 0.000567 |
| Confidence | 0.99 |
