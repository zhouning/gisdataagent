...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000071` |
...
| Metric | `overlap_area_m2` = 2344.441 |
| Overlap area m2 | 2344.441 |
| Left overlap ratio | 0.535952 |
| Right overlap ratio | 0.000126 |
| Confidence | 0.99 |
