...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000096` |
...
| Metric | `overlap_area_m2` = 985.664 |
| Overlap area m2 | 985.664 |
| Left overlap ratio | 0.723606 |
