...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000135` |
...
| Metric | `overlap_area_m2` = 21694.603 |
| Overlap area m2 | 21694.603 |
| Left overlap ratio | 0.797812 |
| Right overlap ratio | 0.001166 |
| Confidence | 0.99 |
