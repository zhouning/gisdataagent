...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000133` |
...
| Metric | `overlap_area_m2` = 71.121 |
| Overlap area m2 | 71.121 |
| Left overlap ratio | 0.002615 |
