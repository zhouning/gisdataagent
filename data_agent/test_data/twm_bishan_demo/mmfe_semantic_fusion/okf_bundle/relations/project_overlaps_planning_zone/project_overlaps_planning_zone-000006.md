...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000006` |
...
| Metric | `overlap_area_m2` = 43151.839 |
| Overlap area m2 | 43151.839 |
| Left overlap ratio | 0.258047 |
| Right overlap ratio | 0.00859 |
| Confidence | 0.99 |
