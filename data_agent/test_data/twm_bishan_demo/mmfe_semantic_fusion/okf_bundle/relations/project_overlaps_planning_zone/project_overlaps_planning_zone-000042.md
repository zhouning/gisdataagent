...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000042` |
...
| Metric | `overlap_area_m2` = 9971.665 |
| Overlap area m2 | 9971.665 |
| Left overlap ratio | 0.677893 |
| Right overlap ratio | 0.000316 |
| Confidence | 0.99 |
