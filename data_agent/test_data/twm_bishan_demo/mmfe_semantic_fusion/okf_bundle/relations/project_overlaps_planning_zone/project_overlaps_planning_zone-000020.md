...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000020` |
...
| Metric | `overlap_area_m2` = 1240.802 |
| Overlap area m2 | 1240.802 |
| Left overlap ratio | 0.092748 |
| Right overlap ratio | 0.000247 |
| Confidence | 0.99 |
