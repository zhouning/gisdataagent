...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000122` |
...
| Metric | `overlap_area_m2` = 73630.762 |
| Overlap area m2 | 73630.762 |
| Left overlap ratio | 0.728046 |
| Right overlap ratio | 0.003956 |
| Confidence | 0.99 |
