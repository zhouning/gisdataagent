...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000010` |
| Relation type | `project_overlaps_planning_zone` |
| Predicate | 落入用途管制分区 |
| Source object | `project` / `PRJ-DEMO-0002` |
| Target object | `planning_zone` / `PLAN-DEMO-002` |
| Target standard role | `planning_zone` |
| TWM usage | `planning_consistency_assessment` |
| Metric | `overlap_area_m2` = 52543.991 |
| Overlap area m2 | 52543.991 |
| Left overlap ratio | 0.322126 |
| Right overlap ratio | 0.010459 |
| Confidence | 0.99 |
