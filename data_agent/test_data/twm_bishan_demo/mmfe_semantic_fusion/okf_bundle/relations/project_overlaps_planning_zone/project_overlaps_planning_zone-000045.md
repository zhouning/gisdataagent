...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000045` |
...
| Metric | `overlap_area_m2` = 2504.923 |
| Overlap area m2 | 2504.923 |
| Left overlap ratio | 0.319826 |
| Right overlap ratio | 7.9e-05 |
| Confidence | 0.99 |
