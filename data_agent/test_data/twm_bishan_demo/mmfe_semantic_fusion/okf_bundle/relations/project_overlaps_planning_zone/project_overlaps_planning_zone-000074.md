...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000074` |
...
| Metric | `overlap_area_m2` = 343.667 |
| Overlap area m2 | 343.667 |
| Left overlap ratio | 0.129666 |
| Right overlap ratio | 8.2e-05 |
| Confidence | 0.99 |
