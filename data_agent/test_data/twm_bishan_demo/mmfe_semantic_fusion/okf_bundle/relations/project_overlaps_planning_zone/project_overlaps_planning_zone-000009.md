...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000009` |
...
| Metric | `overlap_area_m2` = 46673.615 |
| Overlap area m2 | 46673.615 |
| Left overlap ratio | 0.286137 |
| Right overlap ratio | 0.002507 |
| Confidence | 0.99 |
