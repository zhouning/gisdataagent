...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000070` |
...
| Metric | `overlap_area_m2` = 1493.472 |
| Overlap area m2 | 1493.472 |
| Left overlap ratio | 0.341416 |
| Right overlap ratio | 4.7e-05 |
| Confidence | 0.99 |
