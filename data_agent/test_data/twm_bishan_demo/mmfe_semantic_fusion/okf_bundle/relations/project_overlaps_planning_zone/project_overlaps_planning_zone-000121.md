...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000121` |
...
| Metric | `overlap_area_m2` = 34079.826 |
| Overlap area m2 | 34079.826 |
| Left overlap ratio | 0.299653 |
| Right overlap ratio | 0.001831 |
| Confidence | 0.99 |
