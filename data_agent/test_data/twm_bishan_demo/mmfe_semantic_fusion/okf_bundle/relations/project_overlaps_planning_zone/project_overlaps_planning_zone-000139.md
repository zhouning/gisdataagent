...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000139` |
...
| Metric | `overlap_area_m2` = 124.474 |
| Overlap area m2 | 124.474 |
| Left overlap ratio | 0.001366 |
| Right overlap ratio | 7e-06 |
| Confidence | 0.99 |
