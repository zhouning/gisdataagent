...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000050` |
...
| Metric | `overlap_area_m2` = 200.615 |
| Overlap area m2 | 200.615 |
| Left overlap ratio | 0.020862 |
