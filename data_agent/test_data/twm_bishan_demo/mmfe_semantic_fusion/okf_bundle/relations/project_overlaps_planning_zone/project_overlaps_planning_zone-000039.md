...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000039` |
...
| Metric | `overlap_area_m2` = 1948.52 |
| Overlap area m2 | 1948.52 |
| Left overlap ratio | 0.13632 |
| Right overlap ratio | 0.000465 |
| Confidence | 0.99 |
