...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000091` |
...
| Metric | `overlap_area_m2` = 3148.883 |
| Overlap area m2 | 3148.883 |
| Left overlap ratio | 0.563856 |
| Right overlap ratio | 0.000627 |
| Confidence | 0.99 |
