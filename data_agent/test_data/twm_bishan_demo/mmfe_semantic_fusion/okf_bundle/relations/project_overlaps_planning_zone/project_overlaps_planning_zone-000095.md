...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000095` |
...
| Metric | `overlap_area_m2` = 1531.728 |
| Overlap area m2 | 1531.728 |
| Left overlap ratio | 0.147311 |
| Right overlap ratio | 0.000305 |
| Confidence | 0.99 |
