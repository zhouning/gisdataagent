...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000093` |
...
| Metric | `overlap_area_m2` = 3062.923 |
| Overlap area m2 | 3062.923 |
| Left overlap ratio | 0.29457 |
| Right overlap ratio | 9.7e-05 |
| Confidence | 0.99 |
