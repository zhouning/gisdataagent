...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000036` |
...
| Metric | `overlap_area_m2` = 3428.375 |
| Overlap area m2 | 3428.375 |
| Left overlap ratio | 0.126077 |
| Right overlap ratio | 0.000682 |
| Confidence | 0.99 |
