...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000081` |
...
| Metric | `overlap_area_m2` = 15974.059 |
| Overlap area m2 | 15974.059 |
| Left overlap ratio | 0.401692 |
| Right overlap ratio | 0.000858 |
| Confidence | 0.99 |
