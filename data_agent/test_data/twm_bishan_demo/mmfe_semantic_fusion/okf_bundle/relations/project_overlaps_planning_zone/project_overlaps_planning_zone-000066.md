...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000066` |
...
| Metric | `overlap_area_m2` = 966.358 |
| Overlap area m2 | 966.358 |
| Left overlap ratio | 0.211643 |
| Right overlap ratio | 0.000231 |
| Confidence | 0.99 |
