...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000003` |
...
| Metric | `overlap_area_m2` = 14046.302 |
| Overlap area m2 | 14046.302 |
| Left overlap ratio | 0.083997 |
| Right overlap ratio | 0.003353 |
| Confidence | 0.99 |
