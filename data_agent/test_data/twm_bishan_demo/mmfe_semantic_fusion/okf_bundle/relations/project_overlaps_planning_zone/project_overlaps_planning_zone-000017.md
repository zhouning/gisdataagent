...
| Property | Value |
| --- | --- |
| Relation ID | `PROJECT_OVERLAPS_PLANNING_ZONE-000017` |
...
| Metric | `overlap_area_m2` = 388.973 |
| Overlap area m2 | 388.973 |
| Left overlap ratio | 0.019373 |
| Right overlap ratio | 9.3e-05 |
| Confidence | 0.99 |
