...
# Load prompts from the correct path
PROMPTS_FILE = os.path.join(os.path.dirname(__file__), 'prompts', 'optimization.yaml')
...
"""
        ...
        # 3. Verify the instruction contains key constraints
