...
localization["mdExportMenu"]="Markdown 导出菜单";
localization["copyMd"]="复制为 Markdown";
localization["copyMdDesc"]="将主题复制为适用于 LLM 的 Markdown";
localization["copyMdDescLocal"]="仅在 HTTP 服务器上可用";
localization["viewMd"]="以 Markdown 查看";
localization["viewMdDesc"]="以纯文本查看主题";
localization["switchTheme"]="切换主题";
localization["enterFullscreen"]="最大化至全宽";
localization["exitFullscreen"]="恢复至正常宽度";
localization["label.see"]="见";
localization["label.see_also"]="参见";
