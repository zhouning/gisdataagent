...
- Failed gates: `renderer_gate, simulator_gate, planner_gate, negative_control_gate, leakage_guard_gate`

## Gates

- `dataset_integrity_gate`: `pass`; missing/review: none
- `renderer_gate`: `fail`; missing/review: canonical_observation_schema_present, simulator_consumable_observation
...
- `leakage_guard_gate`: `fail`; missing/review: target_feature_columns_present_in_source, feature_vector_contract
...
- Expose canonical_observation with schema territory_world_model.runtime_observation.v1.
