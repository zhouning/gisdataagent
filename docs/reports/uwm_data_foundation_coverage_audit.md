...
- TAP Tracking Air Pollution in China 本地包已解析并登记为 `tap_pm25_observed_gridded_chongqing_2018_2024`：1km PM2.5 rows = 9,451,218，valid rows = 9,422,882，10km species rows = 23,746；250-series-per-period gridded temporal benchmark 的 best UWM MAE = 6.556565，best static baseline MAE = 9.255467，MAE reduction = 2.698902，claim boundary = `bounded_support`。它是多源融合格网产品，不是 station observation 或 observed policy outcome；
