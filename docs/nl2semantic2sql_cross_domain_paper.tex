...
\begin{table}[t]
\centering
\caption{Three-way comparison: direct-LLM baseline, DIN-SQL, and NL2Semantic2SQL Full. DIN-SQL runs: \texttt{cq\_din\_sql\_2026-05-03\_193407} (GIS~20) and \texttt{bird\_din\_sql\_2026-05-03\_193412} (BIRD~500).}
\label{tab:dinsql}
\begin{tabular}{lcccc}
\toprule
...
NL2Semantic2SQL Full  & \textbf{0.900} & \textbf{0.933} & \textbf{0.800} & 0.450 \\
\bottomrule
\end{tabular}
\end{table}
