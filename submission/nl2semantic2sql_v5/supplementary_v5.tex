...
stages (schema linking, classification-and-decomposition, self-correction). The v3
manuscript referenced DIN-SQL on a 15-question Robustness pilot and on the smaller
GIS Spatial split. v5 extends this with two paired comparisons of DIN-SQL against
