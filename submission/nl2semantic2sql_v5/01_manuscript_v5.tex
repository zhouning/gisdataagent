...
\begin{table}[t]
\centering
\caption{Three-way comparison: Baseline vs.\ DIN-SQL vs.\ Full. DIN-SQL on GIS re-implemented for PostgreSQL/PostGIS. The BIRD row is the older 495q comparison only; not directly comparable to the 108q/150q results.}
\label{tab:dinsql}
...
\end{tikzpicture}
\caption{Cross-track EX summary. GIS Spatial 85q: full $0.682$ vs.\ DIN-SQL $0.565$ vs.\ baseline $0.529$ ($p=0.0072$ full vs.\ baseline; $p=0.0213$ full vs.\ DIN-SQL). BIRD design (108q): $0.593$ vs.\ $0.500$ ($p=0.0213$). BIRD held-out (150q): $0.507$ vs.\ $0.473$ ($p=0.3833$, NS).}
\label{fig:cross}
\end{figure}
