...
\bibitem{ogcgeosparql} Open Geospatial Consortium (2012). \emph{OGC GeoSPARQL --- A Geographic Query Language for RDF Data}. OGC Document 11-052r4, Version~1.0. We cite the 1.0 edition because our topological predicate taxonomy (Section~\ref{sec:related}) is normatively defined there; GeoSPARQL 1.1 (OGC 22-047r1) extends this taxonomy and is also available for implementations that need the 1.1 additions. Available at: \url{https://www.ogc.org/publications/standard/geosparql/}.

\bibitem{postgis}
PostGIS Development Team. (2026). \emph{PostGIS 3.5 documentation}, online manual, accessed 2026-05-08.
