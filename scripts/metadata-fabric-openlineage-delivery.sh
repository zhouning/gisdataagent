...
EVIDENCE_OUT="${GDA_LINEAGE_DELIVERY_EVIDENCE_OUT:-${REPO_ROOT}/docs/evidence/metadata-fabric-openlineage-delivery-2026-07-28.json}"
CONTAINER_NAME="gda-metadata-lineage-${$}-${RANDOM}"
DATABASE_NAME="gda_lineage"
...
cd "${REPO_ROOT}"
"${PYTHON_BIN}" -m data_agent.metadata_fabric_lineage_delivery rehearse \
