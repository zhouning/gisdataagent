"""Build UWM livability graph DRL training report from real local data."""
...
OUTPUT_DIR = DATA_ROOT / "livability_graph_drl_training_2026_07_07"
OUTPUT_PATH = OUTPUT_DIR / "uwm_livability_graph_drl_training_report.json"
...
def main() -> None:
    observation = build_admin_livability_graph_observation(
        ...
        observation_id="admin-livability-real-data-graph-drl-training",
    ...
    report = train_livability_graph_dqn_agent(
        env,
        report_id="uwm-livability-real-data-graph-dqn-training-2026-07-07",
    ...
    manifest = {
        "snapshot_id": "uwm_livability_graph_drl_training_2026_07_07",
        "created_at": "2026-07-07T16:15:00Z",
        ...
        "algorithm": report["drl_algorithm"]["algorithm"],
        "is_deep_rl": report["drl_algorithm"]["is_deep_rl"],
        "uses_graph_message_passing": report["drl_algorithm"][
            "uses_graph_message_passing"
        ],
        "training_sample_count": report["training_summary"]["training_sample_count"],
        "holdout_q_return_mae": report["holdout_metrics"]["q_return_mae"],
        ...
        json.dumps(
            {
                ...
                "holdout_q_return_mae": report["holdout_metrics"][
                    "q_return_mae"
                ],
                "holdout_train_mean_return_mae": report["holdout_metrics"][
