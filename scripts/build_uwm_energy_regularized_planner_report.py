"""Build UWM energy-regularized planner report from real local Graph-MDP data."""
...
OUTPUT_DIR = DATA_ROOT / "energy_regularized_planner_2026_07_07"
OUTPUT_PATH = OUTPUT_DIR / "uwm_energy_regularized_planner_report.json"
...
def main() -> None:
    observation = build_admin_livability_graph_observation(
        _read_json(ADMIN_PANEL_PATH),
        observation_id="admin-livability-energy-regularized-planner-2026-07-07",
    ...
    report = plan_with_energy_regularized_action_sequences(
        env,
        graph_drl_training_report=_read_json(GRAPH_DRL_REPORT_PATH),
        report_id="uwm-energy-regularized-planner-2026-07-07",
    ...
    manifest = {
        "snapshot_id": "uwm_energy_regularized_planner_2026_07_07",
        "created_at": "2026-07-07T21:05:00Z",
        ...
        "source_graph_drl_training_report_path": str(
            GRAPH_DRL_REPORT_PATH.relative_to(REPO_ROOT)
        ),
        "algorithm": report["planner_algorithm"]["algorithm"],
        ...
        "planner_exploitation_guard_passed": report["conservative_search_audit"][
            "planner_exploitation_guard_passed"
        ],
        "search_value_alignment_ready": report["search_value_alignment"][
        ...
        json.dumps(
            {
                "report_path": str(OUTPUT_PATH.relative_to(REPO_ROOT)),
                "algorithm": report["planner_algorithm"]["algorithm"],
                "real_data_graph_node_count": report["real_data_graph_mdp_summary"][
                    "real_data_graph_node_count"
                ],
                "real_data_graph_edge_count": report["real_data_graph_mdp_summary"][
                    "real_data_graph_edge_count"
                ],
                "real_data_available_action_count": report[
                    "real_data_graph_mdp_summary"
