...
public final class ChongqingOsmPostgresCdcJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<String> encoded = changelog
                .map(new CheckpointFailureEncoder(options.failAfterCount))
        ...
        encoded
                .sinkTo(
                        FileSink.forRowFormat(
                                ...
                                .build())
                .name("postgres-cdc-versioned-bronze-files")
                .uid("postgres-cdc-versioned-bronze-files");
    ...
    private static final class CheckpointFailureEncoder extends RichMapFunction<Row, String>
        ...
        CheckpointFailureEncoder(int failAfterCount) {
